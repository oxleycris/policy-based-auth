...
namespace PBA.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Register(string returnUrl = null)
        {
            ...
            PopulateRolesListDropdownValues(model);
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser(model.Email, model.GivenName, model.FamilyName, model.BirthDate);
                ...
                if (registerResult.Succeeded)
                {
                    ...
                    var role = _roleManager.FindByIdAsync(model.SelectedRoleId).Result;

                    await _userManager.AddToRoleAsync(user, role.Name);
                    await AddClaims(user, role);
        ...
        private async Task AddClaims(ApplicationUser user, IdentityRole role)
        {
            // Generic claims.
        ...
        private void PopulateRolesListDropdownValues(RegisterViewModel model)
        {
            ...
            model.RolesList = allRoles.Select(s => new SelectListItem
            {
                Value = s.Id,
                Text = s.Name,
                Selected = s.Id == model.SelectedRoleId
            });
        }
